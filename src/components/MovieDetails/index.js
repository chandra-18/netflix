...
class MovieDetails extends Component {
  ...
  getSpecificMovieDetails = async () => {
    ...
    const movieDetailsResponse = await fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=3c6c6b15cf2c223e58665e8f0f8ac2e6&language=en-US`,
    )
    ...
    if (movieDetails.success === false) {
      ...
      const similarMoviesResponse = await fetch(
        `https://api.themoviedb.org/3/movie/${id}/similar?api_key=3c6c6b15cf2c223e58665e8f0f8ac2e6&language=en-US&page=${page}`,
      )
